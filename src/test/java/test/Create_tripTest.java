...
//        File_uploadtest.testFileUploadProcess(); // Ensure file is uploaded
	...
	public static void Trip() throws InterruptedException {
		...
		Assert.assertTrue(!checkBox.isSelected(), "❌ Checkbox not Selected for trip confirmation.");
		checkBox.click();
		...
		driver.findElement(By.xpath(Log_field)).sendKeys("Chetan_par1");
//		Thread.sleep(300);
		driver.findElement(By.xpath(Log_field)).click();
		...
		driver.findElement(By.xpath(Check_box)).click();
		Thread.sleep(1000);		driver.findElement(By.xpath(Create_Trip)).click();
		...
		Thread.sleep(1000);
//		driver.findElement(By.xpath("(//div[@class='v-field__append-inner'])[5]")).click();
//		driver.findElement(By.xpath("(//div[@class='v-field__append-inner'])[5]")).sendKeys("Ch_fle4");
		WebElement executiveInput = driver.findElement(By.xpath(Executive));
		js.executeScript("arguments[0].click();", Executive);
		Assert.assertNotNull(executiveInput, "❌ Executive input field not found.");
		executiveInput.sendKeys("Ch_fle4");

		driver.findElement(By.xpath(Exe)).click();
		driver.findElement(By.xpath(Asexe)).sendKeys("Ch_fle4");
		driver.findElement(By.xpath(Exe)).click();
